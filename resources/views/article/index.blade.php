...
<header class="header_section">
            <div class="container">
               <nav class="navbar navbar-expand-lg custom_nav-container ">
                  <a class="navbar-brand" href="index.html"><img width="120" src="home/images/Threadly_logo.png" alt="#" /></a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav">
                        ...
                        <!-- <li class="nav-item dropdown">
                           ...
                           <ul class="dropdown-menu">
                              <li><a id="logincss" href="{{ route('login') }}">Profile</a></li>
                        ...
                        <li class="nav-item dropdown">
                           <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"> <span class="nav-label">Profile<span class="caret"></span></a>
                           <ul class="dropdown-menu">
                              <li><a id="logincss" href="{{ route('login') }}">Login</a></li>
         ...
         <h2 style="text-align:center;margin-top: 100px;margin-bottom: 100px;">Blog kami</h2>
               <div class="row justify-content-around">
         <div class="col-4">
         <img src="home/images/article.png" alt="">
         </div>
         <div class="col-4">
